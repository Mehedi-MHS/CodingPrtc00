...
*/
names.front();
console.log(names.getElement()); //One

names.next();
console.log(names.getElement()); //Two

names.next();
names.next();
names.prev();
console.log(names.getElement());//Three

console.log(names.find("Five")); //4

names.end();
console.log(names.getElement()); //Five

names.moveTo(3);
console.log(names.getElement()); //Four

names.remove("Two");
console.log(names.toString()); //One,Three,Four,Five

names.insert("Two","One");
console.log(names.toString());//One,Two,Three,Four,Five
