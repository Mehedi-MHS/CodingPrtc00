...
function incrementer() {
  // Copy fixedValue to another variable so that value of 'fixedValue' variable
  // does not change
  let copyOfFixedValue = fixedValue;
  return console.log(copyOfFixedValue + 1); //always return 1 number larger than fixedValue
}
