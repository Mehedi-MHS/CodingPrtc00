...
function translatePigLatin(str) {
  let consonantPref = "ay",
    vowelPref = "way",
    consonantPrefix = str.match(/^[^aeiou]*/),
    consonantSuffix = str.match(/[aeiou]+.*/),
    result;
  if (consonantPrefix[0]) {
    result =
      (consonantSuffix ? consonantSuffix : "") +
      consonantPrefix +
      consonantPref;
  } else if (!consonantPrefix[0]) {
    result = (consonantSuffix ? consonantSuffix : "") + vowelPref;
  }
