...
Animal.prototype.eat = function () {
  console.log("chopat chupat chuuue");
};

let animal = Object.create(Animal.prototype);
//This can also be done using let animal = new Animal();
//But this is complex as said by freecodecamp; so try to use Object.create() method
animal.eat();
console.log(animal instanceof Animal);
//chopat chupat chuuue
//true
